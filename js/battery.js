...
const percentageImage = document.querySelector("img");
console.log(percentageImage.src);
...
function updateBatteryStatus(battery) {
    ...
    percentageImage.src = `https://robohash.org/${chargeLevel.value}`;
    percentageImage.src= percentageImage.src.slice(0,percentageImage.src.length-1);
    console.log(percentageImage.src);
}
